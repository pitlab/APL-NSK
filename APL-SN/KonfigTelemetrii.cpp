// KonfigTelemetrii.cpp: plik implementacji
//

#include "pch.h"
#include "APL-SN.h"
#include "KonfigTelemetrii.h"
#include "afxdialogex.h"
#include "APL-SNDoc.h"
#include "komunikacja/Komunikacja.h"

// Okno dialogowe KonfigTelemetrii

IMPLEMENT_DYNAMIC(KonfigTelemetrii, CDialogEx)

KonfigTelemetrii::KonfigTelemetrii(CWnd* pParent /*=nullptr*/)
...
KonfigTelemetrii::~KonfigTelemetrii()
{
}

void KonfigTelemetrii::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(KonfigTelemetrii, CDialogEx)
	ON_BN_CLICKED(IDOK, &KonfigTelemetrii::OnBnClickedOk)
	ON_NOTIFY(LVN_ITEMCHANGED, IDC_LIST_ZMIENNE_TELE, &KonfigTelemetrii::OnLvnItemchangedListZmienneTele)
	ON_LBN_SELCHANGE(IDC_LISTA_CZESTOTLIWOSCI, &KonfigTelemetrii::OnLbnSelchangeListaCzestotliwosci)
END_MESSAGE_MAP()



// Procedury obsługi komunikatów KonfigTelemetrii
...
// zwraca: nic
///////////////////////////////////////////////////////////////////////////////////////////////////
BOOL KonfigTelemetrii::OnInitDialog()
{
...
///////////////////////////////////////////////////////////////////////////////////////////////////
int KonfigTelemetrii::PozycjaDlaOkresu(int nOkres, uint16_t* sZaokraglonyOkres)
{
	if (nOkres == 0)
	{
...
///////////////////////////////////////////////////////////////////////////////////////////////////
uint16_t KonfigTelemetrii::OkresDlaPozycji(int nPozycja)
{
...
// zwraca: nic
///////////////////////////////////////////////////////////////////////////////////////////////////
void KonfigTelemetrii::OnLvnItemchangedListZmienneTele(NMHDR* pNMHDR, LRESULT* pResult)
{
...
// zwraca: nic
///////////////////////////////////////////////////////////////////////////////////////////////////
void KonfigTelemetrii::OnLbnSelchangeListaCzestotliwosci()
{
	CString strNapis;
...
// zwraca: nic
///////////////////////////////////////////////////////////////////////////////////////////////////
void KonfigTelemetrii::AktualizujZajetoscLacza()
{
	struct
	{
