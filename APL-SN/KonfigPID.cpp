...
BOOL KonfigPID::OnInitDialog()
{
	...
	strParametr.Format(_T("KI kąta przechylenia"));
	m_ctlStrojonyParametr1.InsertString(STRP_KATA_PRZE_KI, strParametr);
	m_ctlStrojonyParametr2.InsertString(STRP_KATA_PRZE_KI, strParametr);
	strParametr.Format(_T("KD kąta przechylenia"));
	m_ctlStrojonyParametr1.InsertString(STRP_KATA_PRZE_KD, strParametr);
	m_ctlStrojonyParametr2.InsertString(STRP_KATA_PRZE_KD, strParametr);
	strParametr.Format(_T("KWyprzedz.kąta przechylenia"));
	...
	strParametr.Format(_T("Podst.fil.D kąta przech"));
	...
	strParametr.Format(_T("Podst.fil.W.Zad kąta prze"));
	...
	strParametr.Format(_T("Podst.fil.W.Wej kąta prze"));
	...
	strParametr.Format(_T("KI prędk.kąt. przechylenia"));
	m_ctlStrojonyParametr1.InsertString(STRP_PRED_PRZE_KI, strParametr);
	m_ctlStrojonyParametr2.InsertString(STRP_PRED_PRZE_KI, strParametr);
	strParametr.Format(_T("KD prędk.kąt. przechylenia"));
	m_ctlStrojonyParametr1.InsertString(STRP_PRED_PRZE_KD, strParametr);
	m_ctlStrojonyParametr2.InsertString(STRP_PRED_PRZE_KD, strParametr);
	strParametr.Format(_T("KWyprzedz.prędk.kąt. prze"));
	...
	strParametr.Format(_T("Podst.fil.D prędk.kąt.prze"));
	...
	strParametr.Format(_T("Podst.fil.W.Zad prędk.kąt.prze"));
	...
	strParametr.Format(_T("Podst.fil.W.Wej prędk.kąt.prze"));
	...
	strParametr.Format(_T("KI kąta pochylenia"));
	m_ctlStrojonyParametr1.InsertString(STRP_KATA_POCH_KI, strParametr);
	m_ctlStrojonyParametr2.InsertString(STRP_KATA_POCH_KI, strParametr);
	strParametr.Format(_T("KD kąta pochylenia"));
	m_ctlStrojonyParametr1.InsertString(STRP_KATA_POCH_KD, strParametr);
	m_ctlStrojonyParametr2.InsertString(STRP_KATA_POCH_KD, strParametr);
	strParametr.Format(_T("KWyprzedz.kąta poch"));
	...
	strParametr.Format(_T("Podst.fil.D kąta poch"));
	...
	strParametr.Format(_T("Podst.fil.W.Zad kąta poch"));
	...
	strParametr.Format(_T("Podst.fil.W.Wej kąta poch"));
	...
	strParametr.Format(_T("KI prędk.kąt. pochylenia"));
	m_ctlStrojonyParametr1.InsertString(STRP_PRED_POCH_KI, strParametr);
	m_ctlStrojonyParametr2.InsertString(STRP_PRED_POCH_KI, strParametr);
	strParametr.Format(_T("KD prędk.kąt. pochylenia"));
	m_ctlStrojonyParametr1.InsertString(STRP_PRED_POCH_KD, strParametr);
	m_ctlStrojonyParametr2.InsertString(STRP_PRED_POCH_KD, strParametr);
	strParametr.Format(_T("KWyprzedz.prędk.kąt.poch"));
	...
	strParametr.Format(_T("Podst.fil.D prędk.kąt.poch"));
	...
	strParametr.Format(_T("Podst.fil.W.Zad prędk.kąt.poch"));
	...
	strParametr.Format(_T("Podst.fil.W.Wej prędk.kąt.poch"));
	...
	strParametr.Format(_T("KI kąta odchylenia"));
	m_ctlStrojonyParametr1.InsertString(STRP_KATA_ODCH_KI, strParametr);
	m_ctlStrojonyParametr2.InsertString(STRP_KATA_ODCH_KI, strParametr);
	strParametr.Format(_T("KD kąta odchylenia"));
	m_ctlStrojonyParametr1.InsertString(STRP_KATA_ODCH_KD, strParametr);
	m_ctlStrojonyParametr2.InsertString(STRP_KATA_ODCH_KD, strParametr);
	strParametr.Format(_T("KWyprzedz.kąta odch"));
	...
	strParametr.Format(_T("Podst.fil.D kąta odch"));
	...
	strParametr.Format(_T("Podst.fil.W.Zad kąta odch"));
	...
	strParametr.Format(_T("Podst.fil.W.Wej kąta odch"));
	...
	strParametr.Format(_T("KI prędk.kąt. odchylenia"));
	m_ctlStrojonyParametr1.InsertString(STRP_PRED_ODCH_KI, strParametr);
	m_ctlStrojonyParametr2.InsertString(STRP_PRED_ODCH_KI, strParametr);
	strParametr.Format(_T("KD prędk.kąt. odchylenia"));
	m_ctlStrojonyParametr1.InsertString(STRP_PRED_ODCH_KD, strParametr);
	m_ctlStrojonyParametr2.InsertString(STRP_PRED_ODCH_KD, strParametr);
	strParametr.Format(_T("KWyprzedz.prędk.kąt.odch"));
	...
	strParametr.Format(_T("Podst.fil.D prędk.kąt.odch"));
	...
	strParametr.Format(_T("Podst.fil.W.Zad prędk.kąt.odch"));
	...
	strParametr.Format(_T("Podst.fil.W.Wej prędk.kąt.odch"));
	...
	strParametr.Format(_T("KI wysokości"));
	m_ctlStrojonyParametr1.InsertString(STRP_WYSOKOSCI_KI, strParametr);
	m_ctlStrojonyParametr2.InsertString(STRP_WYSOKOSCI_KI, strParametr);
	strParametr.Format(_T("KD wysokości"));
	m_ctlStrojonyParametr1.InsertString(STRP_WYSOKOSCI_KD, strParametr);
	m_ctlStrojonyParametr2.InsertString(STRP_WYSOKOSCI_KD, strParametr);
	strParametr.Format(_T("KWyprzedz.wysokości"));
	...
	strParametr.Format(_T("KI prędk.zmiany wysokości"));
	m_ctlStrojonyParametr1.InsertString(STRP_PRED_ZWYS_KI, strParametr);
	m_ctlStrojonyParametr2.InsertString(STRP_PRED_ZWYS_KI, strParametr);
	strParametr.Format(_T("KD prędk.zmiany wysokości"));
	m_ctlStrojonyParametr1.InsertString(STRP_PRED_ZWYS_KD, strParametr);
	m_ctlStrojonyParametr2.InsertString(STRP_PRED_ZWYS_KD, strParametr);
	strParametr.Format(_T("KWyprzedz. prędk.zm.wys"));
	...
	strParametr.Format(_T("Podst.fil.D prędk.zm.wys."));
	...
	strParametr.Format(_T("Podst.fil.W.Zad prędk.zm.wys."));
	...
	strParametr.Format(_T("Podst.fil.W.Wej prędk.zm.wys."));
	...
	strParametr.Format(_T("KI nawig.drogi północnej"));
	m_ctlStrojonyParametr1.InsertString(STRP_NAWI_POLN_KI, strParametr);
	m_ctlStrojonyParametr2.InsertString(STRP_NAWI_POLN_KI, strParametr);
	strParametr.Format(_T("KD nawig.drogi północnej"));
	m_ctlStrojonyParametr1.InsertString(STRP_NAWI_POLN_KD, strParametr);
	m_ctlStrojonyParametr2.InsertString(STRP_NAWI_POLN_KD, strParametr);
	...
	strParametr.Format(_T("KI nawig.prędk.północnej"));
	m_ctlStrojonyParametr1.InsertString(STRP_PRED_POLN_KI, strParametr);
	m_ctlStrojonyParametr2.InsertString(STRP_PRED_POLN_KI, strParametr);
	strParametr.Format(_T("KD nawig.prędk.północnej"));
	m_ctlStrojonyParametr1.InsertString(STRP_PRED_POLN_KD, strParametr);
	m_ctlStrojonyParametr2.InsertString(STRP_PRED_POLN_KD, strParametr);
	...
	strParametr.Format(_T("KI nawig.drogi wschodniej"));
	m_ctlStrojonyParametr1.InsertString(STRP_NAWI_WSCH_KI, strParametr);
	m_ctlStrojonyParametr2.InsertString(STRP_NAWI_WSCH_KI, strParametr);
	strParametr.Format(_T("KD nawig.drogi wschodniej"));
	m_ctlStrojonyParametr1.InsertString(STRP_NAWI_WSCH_KD, strParametr);
	m_ctlStrojonyParametr2.InsertString(STRP_NAWI_WSCH_KD, strParametr);
	...
	strParametr.Format(_T("KI nawig.prędk.wschodniej"));
	m_ctlStrojonyParametr1.InsertString(STRP_PRED_WSCH_KI, strParametr);
	m_ctlStrojonyParametr2.InsertString(STRP_PRED_WSCH_KI, strParametr);
	strParametr.Format(_T("KD nawig.prędk.wschodniej"));
	m_ctlStrojonyParametr1.InsertString(STRP_PRED_WSCH_KD, strParametr);
	m_ctlStrojonyParametr2.InsertString(STRP_PRED_WSCH_KD, strParametr);
