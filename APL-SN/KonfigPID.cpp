...
void KonfigPID::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Text(pDX, IDC_EDIT_PRZESUNIECIE_WYJSCIA_STAB, m_strPrzesunięcieWyjścia1);
...
void KonfigPID::WlaczKontrolki(uint8_t cTrybPracyRegulatora, uint8_t cKanal)
{
	...
	GetDlgItem(IDC_EDIT_PRZESUNIECIE_WYJSCIA_STAB)->EnableWindow((cTrybPracyRegulatora >= REG_STAB) & (cKanal < 4));
