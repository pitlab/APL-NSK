...
/////////////////////////////////////////////////////////////////////////////
// Procedury obsługi komunikatów CWorkspaceBar
...
int CFileView::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	{
		TRACE0("Nie można utworzyć widoku pliku\n");
	...
	m_wndToolBar.LoadToolBar(IDR_EXPLORER, 0, 0, TRUE /* Jest zablokowany */);
...
{
	HTREEITEM hRoot = m_wndFileView.InsertItem(_T("Pliki fikcyjnej aplikacji"), 0, 0);
	m_wndFileView.SetItemState(hRoot, TVIS_BOLD, TVIS_BOLD);

	HTREEITEM hSrc = m_wndFileView.InsertItem(_T("Pliki źródłowe fikcyjnej aplikacji"), 0, 0, hRoot);
	...
	HTREEITEM hInc = m_wndFileView.InsertItem(_T("Pliki nagłówkowe fikcyjnej aplikacji"), 0, 0, hRoot);
	...
	HTREEITEM hRes = m_wndFileView.InsertItem(_T("Pliki zasobów fikcyjnej aplikacji"), 0, 0, hRoot);
...
void CFileView::OnChangeVisualStyle()
{
	...
	m_wndToolBar.LoadBitmap(theApp.m_bHiColorIcons ? IDB_EXPLORER_24 : IDR_EXPLORER, 0, 0, TRUE /* Zablokowano */);
