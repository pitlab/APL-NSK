...
#define FAU_PWM_ZAWISU      FAU_PWM_MIN+2   	//2U wysterowanie regulatorów w zawisie [us]
#define FAU_PWM_MAX         FAU_PWM_ZAWISU+2  	//2U maksymalne wysterowanie silników w trakcie lotu [us]
