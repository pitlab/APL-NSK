	...
	, m_chAdresAutopilota(0)
{
	...
	m_strNazwyZmiennychTele[TID_ZYRO2P]				= "¯yroskop2 P [rad/s]";
	m_strNazwyZmiennychTele[TID_ZYRO2Q]				= "¯yroskop2 Q [rad/s]";
	m_strNazwyZmiennychTele[TID_ZYRO2R]				= "¯yroskop2 R [rad/s]";
	m_strNazwyZmiennychTele[TID_MAGNE1X]			= "Magnetometr 1 X [uT]";
	m_strNazwyZmiennychTele[TID_MAGNE1Y]			= "Magnetometr 1 Y [uT]";
	m_strNazwyZmiennychTele[TID_MAGNE1Z]			= "Magnetometr 1 Z [uT]";
	m_strNazwyZmiennychTele[TID_MAGNE2X]			= "Magnetometr 2 X [uT]";
	m_strNazwyZmiennychTele[TID_MAGNE2Y]			= "Magnetometr 2 Y [uT]";
	m_strNazwyZmiennychTele[TID_MAGNE2Z]			= "Magnetometr 2 Z [uT]";
	m_strNazwyZmiennychTele[TID_MAGNE3X]			= "Magnetometr 3 X [uT]";
	m_strNazwyZmiennychTele[TID_MAGNE3Y]			= "Magnetometr 3 Y [uT]";
	m_strNazwyZmiennychTele[TID_MAGNE3Z]			= "Magnetometr 3 Z [uT]";
	m_strNazwyZmiennychTele[TID_TEMPIMU1]			= "Temperatura IMU1 [K]";
	m_strNazwyZmiennychTele[TID_TEMPIMU2]			= "Temperatura IMU2 [K]";

	//zmienna AHRS
	m_strNazwyZmiennychTele[TID_KAT_IMU1X]			= "Trygono. Phi [rad]";
	m_strNazwyZmiennychTele[TID_KAT_IMU1Y]			= "Trygono. Theta [rad]";
	m_strNazwyZmiennychTele[TID_KAT_IMU1Z]			= "Trygono. Psi [rad]";
	m_strNazwyZmiennychTele[TID_KAT_IMU2X]			= "Kwatern. Phi [rad]";
	m_strNazwyZmiennychTele[TID_KAT_IMU2Y]			= "Kwatern. Theta [rad]";
	m_strNazwyZmiennychTele[TID_KAT_IMU2Z]			= "Kwatern. Psi [rad]";
	m_strNazwyZmiennychTele[TID_KAT_ZYRO1X]			= "¯yro. Phi [rad]";
	m_strNazwyZmiennychTele[TID_KAT_ZYRO1Y]			= "¯yro. Theta [rad]";
	m_strNazwyZmiennychTele[TID_KAT_ZYRO1Z]			= "¯yro. Psi [rad]";
	m_strNazwyZmiennychTele[TID_KAT_AKCELX]			= "Akcel. Phi [rad]";
	m_strNazwyZmiennychTele[TID_KAT_AKCELY]			= "Akcel. Theta [rad]";
	m_strNazwyZmiennychTele[TID_KAT_AKCELZ]			= "Akcel. Psi [rad]";
	...
	m_strNazwyZmiennychTele[TID_PREDIAS2]			= "Prêdkoœæ IAS2 [m/s]";
	m_strNazwyZmiennychTele[TID_WARIO1]				= "Prêdk.zm.wys.1 [m/s]";
	m_strNazwyZmiennychTele[TID_WARIO2]				= "Prêdk.zm.wys.2 [m/s]";

	m_strNazwyZmiennychTele[TID_TEMPCISB1]			= "Temp.Ciœn.Bzwz1 [K]";
	m_strNazwyZmiennychTele[TID_TEMPCISB2]			= "Temp.Ciœn.Bzwz2 [K]";
	m_strNazwyZmiennychTele[TID_TEMPCISR1]			= "Temp.Ciœn.Ró¿n1 [K]";
	m_strNazwyZmiennychTele[TID_TEMPCISR2]			= "Temp.Ciœn.Ró¿n2 [K]";

	//odbiorniki RC i serwa
	m_strNazwyZmiennychTele[TID_RC_KAN1]			= "Odb RC kan.1 [us]";
	m_strNazwyZmiennychTele[TID_RC_KAN2]			= "Odb RC kan.2 [us]";
	m_strNazwyZmiennychTele[TID_RC_KAN3]			= "Odb RC kan.3 [us]";
	m_strNazwyZmiennychTele[TID_RC_KAN4]			= "Odb RC kan.4 [us]";
	m_strNazwyZmiennychTele[TID_RC_KAN5]			= "Odb RC kan.5 [us]";
	m_strNazwyZmiennychTele[TID_RC_KAN6]			= "Odb RC kan.6 [us]";
	m_strNazwyZmiennychTele[TID_RC_KAN7]			= "Odb RC kan.7 [us]";
	m_strNazwyZmiennychTele[TID_RC_KAN8]			= "Odb RC kan.8 [us]";
	m_strNazwyZmiennychTele[TID_RC_KAN9]			= "Odb RC kan.9 [us]";
	m_strNazwyZmiennychTele[TID_RC_KAN10]			= "Odb RC kan.10 [us]";
	m_strNazwyZmiennychTele[TID_RC_KAN11]			= "Odb RC kan.11 [us]";
	m_strNazwyZmiennychTele[TID_RC_KAN12]			= "Odb RC kan.12 [us]";
	m_strNazwyZmiennychTele[TID_RC_KAN13]			= "Odb RC kan.13 [us]";
	m_strNazwyZmiennychTele[TID_RC_KAN14]			= "Odb RC kan.14 [us]";
	m_strNazwyZmiennychTele[TID_RC_KAN15]			= "Odb RC kan.15 [us]";
	m_strNazwyZmiennychTele[TID_RC_KAN16]			= "Odb RC kan.16 [us]";

	m_strNazwyZmiennychTele[TID_SERWO1]				= "Serwo kan.1 [us]";
	m_strNazwyZmiennychTele[TID_SERWO2]				= "Serwo kan.2 [us]";
	m_strNazwyZmiennychTele[TID_SERWO3]				= "Serwo kan.3 [us]";
	m_strNazwyZmiennychTele[TID_SERWO4]				= "Serwo kan.4 [us]";
	m_strNazwyZmiennychTele[TID_SERWO5]				= "Serwo kan.5 [us]";
	m_strNazwyZmiennychTele[TID_SERWO6]				= "Serwo kan.6 [us]";
	m_strNazwyZmiennychTele[TID_SERWO7]				= "Serwo kan.7 [us]";
	m_strNazwyZmiennychTele[TID_SERWO8]				= "Serwo kan.8 [us]";
	m_strNazwyZmiennychTele[TID_SERWO9]				= "Serwo kan.9 [us]";
	m_strNazwyZmiennychTele[TID_SERWO10]			= "Serwo kan.10 [us]";
	m_strNazwyZmiennychTele[TID_SERWO11]			= "Serwo kan.11 [us]";
	m_strNazwyZmiennychTele[TID_SERWO12]			= "Serwo kan.12 [us]";
	m_strNazwyZmiennychTele[TID_SERWO13]			= "Serwo kan.13 [us]";
	m_strNazwyZmiennychTele[TID_SERWO14]			= "Serwo kan.14 [us]";
	...
	m_strNazwyZmiennychTele[TID_PID_PRZE_FZAD]		= "Filtr war.zad.przech";	//przefiltrowana (0..255) wartoœæ zadana dla cz³onu wyprzedzenia
	m_strNazwyZmiennychTele[TID_PID_PRZE_FWEJ]		= "Filtr wej. przech";		//przefiltrowana (0..15) wartoœæ wejœciowa dla wszystkich cz³onów
	m_strNazwyZmiennychTele[TID_PID_PRZE_FROZ]		= "Filtr ró¿n.przech";		//przefiltrowana (0..255) wartoœæ wejœciowa dla cz³onu ró¿niczkuj¹cego
	m_strNazwyZmiennychTele[TID_PID_PRZE_WY_P]		= "Wyj P przechylenia";		//wyjœcie cz³onu P
	m_strNazwyZmiennychTele[TID_PID_PRZE_WY_I]		= "Wyj I przechylenia";		//wyjœcie cz³onu I
	m_strNazwyZmiennychTele[TID_PID_PRZE_WY_D]		= "Wyj D przechylenia";		//wyjœcie cz³onu D
	m_strNazwyZmiennychTele[TID_PID_PRZE_WYPRZ]		= "Wyprzedz.k¹ta przech";	//wyjœcie cz³onu wyprzedzenia k¹ta
	...
	m_strNazwyZmiennychTele[TID_PID_PK_PRZE_FZAD]	= "Fil.w.zad.pr.k¹t.prze";	//przefiltrowana (0..255) wartoœæ zadana dla cz³onu wyprzedzenia
	m_strNazwyZmiennychTele[TID_PID_PK_PRZE_FWEJ]	= "Fil.w.wej.pr.k¹t.prze";	//przefiltrowana (0..15) wartoœæ wejœciowa dla wszystkich cz³onów
	m_strNazwyZmiennychTele[TID_PID_PK_PRZE_FROZ]	= "Fil.ró¿n.pr.k¹t.prze";	//przefiltrowana (0..255) wartoœæ wejœciowa dla cz³onu ró¿niczkuj¹cego
	m_strNazwyZmiennychTele[TID_PID_PK_PRZE_WY_P]	= "Wyj P pr.k¹t.prze";		//wyjœcie cz³onu P
	m_strNazwyZmiennychTele[TID_PID_PK_PRZE_WY_D]	= "Wyj D pr.k¹t.prze";		//wyjœcie cz³onu D
	m_strNazwyZmiennychTele[TID_PID_PK_PRZE_WYPRZ]	= "Wyprzedz. pr.k¹t.prze";	//wartoœæ wyprzedzaj¹ca
	m_strNazwyZmiennychTele[TID_PID_PK_PRZE_WYJ]	= "Wyj PID pr.k¹t.prze";	//wyjœcie regulatora sterowania prêdkoœci¹ k¹tow¹ przechylenia

	m_strNazwyZmiennychTele[TID_PID_POCH_WZAD]		= "Wart.zadana pochylenia";	//wartoœæ zadana regulatora sterowania pochyleniem
	m_strNazwyZmiennychTele[TID_PID_POCH_FZAD]		= "Filtr war.zad.pochyl";	//przefiltrowana (0..255) wartoœæ zadana dla cz³onu wyprzedzenia
	m_strNazwyZmiennychTele[TID_PID_POCH_FWEJ]		= "Filtr wej. pochyl";		//przefiltrowana (0..15) wartoœæ wejœciowa dla wszystkich cz³onów
	m_strNazwyZmiennychTele[TID_PID_POCH_FROZ]		= "Filtr ró¿n.pochyl";		//przefiltrowana (0..255) wartoœæ wejœciowa dla cz³onu ró¿niczkuj¹cego
	m_strNazwyZmiennychTele[TID_PID_POCH_WY_P]		= "Wyj P pochylenia";		//wyjœcie cz³onu P
	m_strNazwyZmiennychTele[TID_PID_POCH_WY_I]		= "Wyj I pochylenia";		//wyjœcie cz³onu I
	m_strNazwyZmiennychTele[TID_PID_POCH_WY_D]		= "Wyj D pochylenia";		//wyjœcie cz³onu D
	m_strNazwyZmiennychTele[TID_PID_POCH_WYPRZ]		= "Wyprzedz.k¹ta pochyl";	//wyjœcie cz³onu wyprzedzenia k¹ta
	...
	m_strNazwyZmiennychTele[TID_PID_PK_POCH_FZAD]	= "Fil.w.zad.pr.k¹t.poch";	//przefiltrowana (0..255) wartoœæ zadana dla cz³onu wyprzedzenia
	m_strNazwyZmiennychTele[TID_PID_PK_POCH_FWEJ]	= "Fil.w.wej.pr.k¹t.poch";	//przefiltrowana (0..15) wartoœæ wejœciowa dla wszystkich cz³onów
	m_strNazwyZmiennychTele[TID_PID_PK_POCH_FROZ]	= "Fil.ró¿n.pr.k¹t.poch";	//przefiltrowana (0..255) wartoœæ wejœciowa dla cz³onu ró¿niczkuj¹cego
	m_strNazwyZmiennychTele[TID_PID_PK_POCH_WY_P]	= "Wyj P pr.k¹t.poch";		//wyjœcie cz³onu P
	m_strNazwyZmiennychTele[TID_PID_PK_POCH_WY_D]	= "Wyj D pr.k¹t.poch";		//wyjœcie cz³onu D
	m_strNazwyZmiennychTele[TID_PID_PK_POCH_WYPRZ]	= "Wyprzedz. pr.k¹t.poch";	//wartoœæ wyprzedzaj¹ca
	m_strNazwyZmiennychTele[TID_PID_PK_POCH_WYJ]	= "Wyj PID pr.k¹t.poch";	//wyjœcie regulatora sterowania prêdkoœci¹ k¹tow¹ pochylenia

	m_strNazwyZmiennychTele[TID_PID_ODCH_WZAD]		= "Wart.zadana odchenia";	//wartoœæ zadana regulatora sterowania odchyleniem
	m_strNazwyZmiennychTele[TID_PID_ODCH_FZAD]		= "Filtr war.zad.odchyl";	//przefiltrowana (0..255) wartoœæ zadana dla cz³onu wyprzedzenia
	m_strNazwyZmiennychTele[TID_PID_ODCH_FWEJ]		= "Filtr wej. odchylenia";	//przefiltrowana (0..15) wartoœæ wejœciowa dla wszystkich cz³onów
	m_strNazwyZmiennychTele[TID_PID_ODCH_FROZ]		= "Filtr ró¿n.odchylenia";	//przefiltrowana(0..255) wartoœæ wejœciowa dla cz³onu ró¿niczkuj¹cego
	m_strNazwyZmiennychTele[TID_PID_ODCH_WY_P]		= "Wyjœcie P odchylenia";	//wyjœcie cz³onu P
	m_strNazwyZmiennychTele[TID_PID_ODCH_WY_I]		= "Wyjœcie I odchylenia";	//wyjœcie cz³onu I
	m_strNazwyZmiennychTele[TID_PID_ODCH_WY_D]		= "Wyjœcie D odchylenia";	//wyjœcie cz³onu D
	m_strNazwyZmiennychTele[TID_PID_ODCH_WYPRZ]		= "Wyprzedz. k¹ta odchyl";	//wyjœcie cz³onu wyprzedzenia k¹ta
	...
	m_strNazwyZmiennychTele[TID_PID_PK_ODCH_FZAD]	= "Fil.w.zad.pr.k¹t.odch";	//przefiltrowana (0..255) wartoœæ zadana dla cz³onu wyprzedzenia
	m_strNazwyZmiennychTele[TID_PID_PK_ODCH_FWEJ]	= "Fil.w.wej.pr.k¹t.odch";	//przefiltrowana (0..15) wartoœæ wejœciowa dla wszystkich cz³onów
	m_strNazwyZmiennychTele[TID_PID_PK_ODCH_FROZ]	= "Filtr.ró¿n.pr.k¹t.odch";	//przefiltrowana (0..255) wartoœæ wejœciowa dla cz³onu ró¿niczkuj¹cego
	m_strNazwyZmiennychTele[TID_PID_PK_ODCH_WY_P]	= "Wyj P pr.k¹t.odch";		//wyjœcie cz³onu P
	m_strNazwyZmiennychTele[TID_PID_PK_ODCH_WY_D]	= "Wyj D pr.k¹t.odch";		//wyjœcie cz³onu D
	m_strNazwyZmiennychTele[TID_PID_PK_ODCH_WYPRZ]	= "Wyprzedz. pr.k¹t.odch";	//wartoœæ wyprzedzaj¹ca
	m_strNazwyZmiennychTele[TID_PID_PK_ODCH_WYJ]	= "Wyj. PID pr.k¹t.odch";	//wyjœcie regulatora sterowania prêdkoœci¹ k¹tow¹ odchylenia

	m_strNazwyZmiennychTele[TID_PID_WYSO_WZAD]		= "Wart.zadana wysokoœci";	//wartoœæ zadana regulatora sterowania wysokoœci¹
	m_strNazwyZmiennychTele[TID_PID_WYSO_FZAD]		= "Filtr war.zad.wysoko";	//przefiltrowana (0..255) wartoœæ zadana dla cz³onu wyprzedzenia
	m_strNazwyZmiennychTele[TID_PID_WYSO_FWEJ]		= "Filtr wej. wysokoœci";	//przefiltrowana (0..15) wartoœæ wejœciowa dla wszystkich cz³onów
	m_strNazwyZmiennychTele[TID_PID_WYSO_FROZ]		= "Filtr ró¿n.wysokoœci";	//przefiltrowana (0..255) wartoœæ wejœciowa dla cz³onu ró¿niczkuj¹cego
	m_strNazwyZmiennychTele[TID_PID_WYSO_WY_P]		= "Wyjœcie P wysokoœci";	//wyjœcie cz³onu P
	m_strNazwyZmiennychTele[TID_PID_WYSO_WY_I]		= "Wyjœcie I wysokoœci";	//wyjœcie cz³onu I
	m_strNazwyZmiennychTele[TID_PID_WYSO_WY_D]		= "Wyjœcie D wysokoœci";	//wyjœcie cz³onu D
	m_strNazwyZmiennychTele[TID_PID_WYSO_WYPRZ]		= "Wyprzedz.wysokosci";		//wyjœcie cz³onu wyprzedzenia wysokoœci
	m_strNazwyZmiennychTele[TID_PID_WYSO_WYJ]		= "Wy PID wysokoœci";		//wyjœcie regulatora sterowania wysokoœci¹
	m_strNazwyZmiennychTele[TID_PID_PR_WYSO_WZAD]	= "Wart.zad.pr.zm.wysoko";	//wartoœæ zadana regulatora prêdkoœci zmiany wysokoœci
	m_strNazwyZmiennychTele[TID_PID_PR_WYSO_FZAD]	= "Filtr.w.zad.pr.zm.wys";	//przefiltrowana (0..255) wartoœæ zadana dla cz³onu wyprzedzenia
	m_strNazwyZmiennychTele[TID_PID_PR_WYSO_FWEJ]	= "Filtr.we.pr.zm.wysoko";	//przefiltrowana (0..15) wartoœæ wejœciowa dla wszystkich cz³onów
	m_strNazwyZmiennychTele[TID_PID_PK_WYSO_FROZ]	= "Filtr.we.pr.zm.wysoko";	//przefiltrowana (0..255) wartoœæ wejœciowa dla cz³onu ró¿niczkuj¹cego
	m_strNazwyZmiennychTele[TID_PID_PR_WYSO_WY_P]	= "Wyj P pr.zm.wysoko";		//wyjœcie cz³onu P
	m_strNazwyZmiennychTele[TID_PID_PR_WYSO_WY_D]	= "Wyj D pr.zm.wysoko";		//wyjœcie cz³onu D
	m_strNazwyZmiennychTele[TID_PID_PR_WYSO_WYPRZ]	= "Wyprzedz.zm.wysoko";		//wartoœæ wyprzedzaj¹ca
	m_strNazwyZmiennychTele[TID_PID_PR_WYSO_WYJ]	= "Wyj PID pr.zm.wysoko";	//wyjœcie regulatora sterowania prêdkoœci¹ zmiany wysokoœci
	...
	m_strNazwyZmiennychTele[TID_PID_NAWN_FWEJ]		= "Filtr.wejœcie naw. N";	//przefiltrowana (0..15) wartoœæ wejœciowa dla wszystkich cz³onów
	m_strNazwyZmiennychTele[TID_PID_NAWN_FROZ]		= "Filtr ró¿n. nawig.N";	//przefiltrowana (0..255) wartoœæ wejœciowa dla cz³onu ró¿niczkuj¹cego
	m_strNazwyZmiennychTele[TID_PID_NAWN_WY_P]		= "Wyj. P nawigacji N";		//wyjœcie cz³onu P
	m_strNazwyZmiennychTele[TID_PID_NAWN_WY_I]		= "Wyj I nawigacji N";		//wyjœcie cz³onu I
	m_strNazwyZmiennychTele[TID_PID_NAWN_WY_D]		= "Wyj D nawigacji N";		//wyjœcie cz³onu D
	...
	m_strNazwyZmiennychTele[TID_PID_PR_NAWN_FWEJ]	= "Filtr.wej.pr.nawig.N";	//przefiltrowana (0..15) wartoœæ wejœciowa dla wszystkich cz³onów
	m_strNazwyZmiennychTele[TID_PID_PR_NAWN_FROZ]	= "Fil.ró¿n.pr.nawig.N";	//przefiltrowana (0..255) wartoœæ wejœciowa dla cz³onu ró¿niczkuj¹cego
	m_strNazwyZmiennychTele[TID_PID_PR_NAWN_WY_P]	= "Wyj P prêd.nawig.N";		//wyjœcie cz³onu P
	m_strNazwyZmiennychTele[TID_PID_PR_NAWN_WY_I]	= "Wyj I prêd.nawig.N";		//wyjœcie cz³onu I
	m_strNazwyZmiennychTele[TID_PID_PR_NAWN_WY_D]	= "Wyj D prêd.nawig.N";		//wyjœcie cz³onu D
	m_strNazwyZmiennychTele[TID_PID_PR_NAWN_WYJ]	= "Wyj PID pr.nawig.N";		//wyjœcie regulatora sterowania prêdkoœci¹ w kierunku pó³nocnym
	...
	m_strNazwyZmiennychTele[TID_PID_NAWE_FWEJ]		= "Filtr.wejœcie naw.E";	//przefiltrowana (0..15) wartoœæ wejœciowa dla wszystkich cz³onów
	m_strNazwyZmiennychTele[TID_PID_NAWE_FROZ]		= "Filtr ró¿n. nawig.E";	//przefiltrowana (0..255) wartoœæ wejœciowa dla cz³onu ró¿niczkuj¹cego
	m_strNazwyZmiennychTele[TID_PID_NAWE_WY_P]		= "Wyj P nawigacji E";		//wyjœcie cz³onu P
	m_strNazwyZmiennychTele[TID_PID_NAWE_WY_I]		= "Wyj I nawigacji E";		//wyjœcie cz³onu I
	m_strNazwyZmiennychTele[TID_PID_NAWE_WY_D]		= "Wyj D nawigacji E";		//wyjœcie cz³onu D
	m_strNazwyZmiennychTele[TID_PID_NAWE_WYJ]		= "Wyj PID nawig. E";		//wyjœcie regulatora sterowania nawigacj¹ w kierunku wschodnim
	m_strNazwyZmiennychTele[TID_PID_PR_NAWE_WZAD]	= "Wart.zadana pr.naw.E";	//wartoœæ zadana prêdkoœci w kierunku wschodnim
	m_strNazwyZmiennychTele[TID_PID_PR_NAWE_FWEJ]	= "Filtr.we.pr.nawig.E";	//przefiltrowana (0..15) wartoœæ wejœciowa dla wszystkich cz³onów
	m_strNazwyZmiennychTele[TID_PID_PR_NAWE_FROZ]	= "Fil.ró¿n.pr.nawig.E";	//przefiltrowana (0..255) wartoœæ wejœciowa dla cz³onu ró¿niczkuj¹cego
	m_strNazwyZmiennychTele[TID_PID_PR_NAWE_WY_P]	= "Wyj P prêd.nawig.E";		//wyjœcie cz³onu P
	m_strNazwyZmiennychTele[TID_PID_PR_NAWE_WY_I]	= "Wyj I prêd.nawig.E";		//wyjœcie cz³onu I
	m_strNazwyZmiennychTele[TID_PID_PR_NAWE_WY_D]	= "Wyj D prêd.nawig.E";		//wyjœcie cz³onu D
	m_strNazwyZmiennychTele[TID_PID_PR_NAWE_WYJ]	= "Wyj PID pr.nawig.E";		//wyjœcie regulatora sterowania prêdkoœci¹ w kierunku wschodnim
...
uint8_t CKomunikacja::ZapiszDaneU8FRAM(uint8_t* chDane, uint8_t chRozmiar, uint16_t sAdres)
{
	...
	chErr = getProtokol().WyslijOdbierzRamke(m_chAdresAutopilota, ADRES_STACJI, PK_ZAPISZ_FRAM_U8, chDaneWychodzace, chRozmiar + 3, chDanePrzychodzace, &chOdebrano);
	return chErr;
}
...
uint8_t CKomunikacja::ZapiszWysterowanieObrotow(uint16_t sMin, uint16_t sMax, uint16_t sZawis)
{
	...
	chErr = getProtokol().WyslijOdbierzRamke(m_chAdresAutopilota, ADRES_STACJI, PK_ZAPISZ_WYSTER_NAPEDU, chDaneWychodzace, 2*LICZBA_DANYCH_NAPEDU, chDanePrzychodzace, &chOdebrano);
	if ((chErr == ERR_OK) && (chOdebrano >= 2))
	{
