...
class KonfigTelemetrii : public CDialogEx
{
	DECLARE_DYNAMIC(KonfigTelemetrii)

public:
	KonfigTelemetrii(CWnd* pParent = nullptr);   // konstruktor standardowy
	virtual ~KonfigTelemetrii();
